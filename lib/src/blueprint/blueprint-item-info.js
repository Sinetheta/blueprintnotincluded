...
exports.BlueprintItemInfo = exports.InfoIcon = void 0;
...
var InfoIcon;
(function (InfoIcon) {
    InfoIcon[InfoIcon["icon_inf"] = 0] = "icon_inf";
    InfoIcon[InfoIcon["icon_int"] = 1] = "icon_int";
    InfoIcon[InfoIcon["icon_exc"] = 2] = "icon_exc";
    InfoIcon[InfoIcon["icon_no1"] = 3] = "icon_no1";
    InfoIcon[InfoIcon["icon_no2"] = 4] = "icon_no2";
    InfoIcon[InfoIcon["icon_no3"] = 5] = "icon_no3";
    InfoIcon[InfoIcon["icon_no4"] = 6] = "icon_no4";
    InfoIcon[InfoIcon["icon_no5"] = 7] = "icon_no5";
    InfoIcon[InfoIcon["icon_no6"] = 8] = "icon_no6";
    InfoIcon[InfoIcon["icon_no7"] = 9] = "icon_no7";
    InfoIcon[InfoIcon["icon_no8"] = 10] = "icon_no8";
    InfoIcon[InfoIcon["icon_no9"] = 11] = "icon_no9";
})(InfoIcon = exports.InfoIcon || (exports.InfoIcon = {}));
class BlueprintItemInfo extends blueprint_item_1.BlueprintItem {
    get htmlFrontColor() { return draw_helpers_1.DrawHelpers.colorToHex(this.frontColor); }
    get htmlBackColor() { return draw_helpers_1.DrawHelpers.colorToHex(this.backColor); }
    get htmlSvgPath() { return BlueprintItemInfo.getIconSvgPath(this.icon); }
    constructor(id) {
        super(id);
        this.infoString = '';
        this.title = '';
        this.backColor = 0x007AD9;
        this.frontColor = 0xFFFFFF;
        this.icon = InfoIcon.icon_inf;
    }
    ...
    importMdbBuilding(original) {
        if (original.infoString == null)
            this.infoString = BlueprintItemInfo.defaultInfoString;
        else
            this.infoString = original.infoString;
        if (original.title == null)
            this.title = BlueprintItemInfo.defaultTitle;
        else
            this.title = original.title;
        if (original.backColor == null)
            this.backColor = BlueprintItemInfo.defaultBackColor;
        else
            this.backColor = original.backColor;
        if (original.frontColor == null)
            this.frontColor = BlueprintItemInfo.defaultFrontColor;
        else
            this.frontColor = original.frontColor;
        if (original.icon == null)
            this.icon = BlueprintItemInfo.defaultIcon;
        else
    ...
    toMdbBuilding() {
        ...
        if (this.title != BlueprintItemInfo.defaultTitle)
        ...
        if (this.icon != BlueprintItemInfo.defaultIcon)
            returnValue.icon = this.icon;
        return returnValue;
    }
    cleanUp() {
    ...
    cameraChanged(camera) {
        ...
        for (let drawPart of this.drawParts) {
            if (drawPart.hasTag(sprite_tag_1.SpriteTag.info_back)) {
            ...
            else if (drawPart.hasTag(sprite_tag_1.SpriteTag.info_front)) {
                drawPart.visible = true;
                drawPart.zIndex = 0;
                drawPart.alpha = 1;
...
exports.BlueprintItemInfo = BlueprintItemInfo;
BlueprintItemInfo.defaultInfoString = '';
BlueprintItemInfo.defaultTitle = '';
BlueprintItemInfo.defaultBackColor = 0x007AD9;
BlueprintItemInfo.defaultFrontColor = 0xFFFFFF;
BlueprintItemInfo.defaultIcon = InfoIcon.icon_inf;
